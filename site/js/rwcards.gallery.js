/*
	...
	- LoadBrain (www.weberr.de): Fixed for use with Joomla 3, Mootools 1.4.x
*/
...
var gallery = {
	...
	populateData: function() {
		...
		var data = Array.from(this.galleryData);
		data.append(this.populateGallery(this.populateFrom, currentArrayPlace));
